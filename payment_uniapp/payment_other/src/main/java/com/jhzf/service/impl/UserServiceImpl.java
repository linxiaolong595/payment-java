...
public class UserServiceImpl implements UserService {
    ...
    public ResponseDTO register(LoginVo loginVo) {
        ...
        if(res == 1){
            ...
            userMapper.regist(loginVo.getAccount(), com.jhzf.utils.Md5.getString(loginVo.getPwd()),loginVo.getNickName());
    ...
    public ResponseDTO accountLogin(String account, String pwd) {
        int res = userMapper.accountLogin(account, com.jhzf.utils.Md5.getString(pwd));
        if(res == 1){
    ...
    public ResponseDTO modifyPwd(ModifyPwdVo vo) {
        ...
        List<PaymentUser> userMsg = userMapper.selectUserMsg(vo.getUserId(), com.jhzf.utils.Md5.getString(vo.getOldPwd()));
        if (userMsg.size() > 0){
            int i = userMapper.modifyPwd(vo.getUserId(), com.jhzf.utils.Md5.getString(vo.getNewPwd()));
            if (i > 0){
